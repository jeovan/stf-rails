class Sitafe::SitafePessoaUsuComentario < ApplicationRecord
	
	belongs_to :sitafe_pessoa, foreign_key: 'tuk', primary_key: 'tuk'

	self.table_name = 'SITAFE.SITAFE_PESSOA_USU_COMENTARIO'
	...
	def initialize(options = {})
		...
		if self.m_occurs == 0
			last_m_occurs_of_tuk = Sitafe::SitafePessoaUsuComentario.where(tuk: self.tuk).last
